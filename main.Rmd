...
ggplot(df_prop, aes(x = factor(cluster), y = autor, fill = prop)) +
  ...
  labs(
    x = "Cluster SOM",
    y = "Autor",
    title = "Heatmap: proporción de mensajes de cada autor por cluster"
  ) +
  theme_minimal() +
...
ggplot(df_dom, aes(x = reorder(autor, prop), y = prop, fill = factor(cluster))) +
  geom_col() +
  coord_flip() +
  ...
  labs(
    ...
    fill = "Cluster",
    title = "Cluster mayoritario por autor"
  ) +
  theme_minimal()
